...
- `git` como sistema de versionamento de código
- GitHub para hospedagem de código, colaboração e ambiente de CI (integração contínua)
- `jest` para testes automatizados
- `prettier` como linter de estilo de código
