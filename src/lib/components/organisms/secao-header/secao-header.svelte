...
<header class="flex flex-col gap-5 lg:pb-10 items-end justify-center">
  <Topbar />
  <div
    class="flex flex-wrap max-lg:gap-3 lg:gap-5 items-center justify-between nlf-padding nlf-container"
  >
    <!-- {#if tema.padrao === "light"}
      <a href="/">
        <img
          src={"/assets/logo-nlf-solida-azul-w200.webp"}
          alt=""
          class="w-full max-lg:max-w-[100px] lg:max-w-[150px] aspect-200/114 order-1"
        />
      </a>
    {:else}
      <a href="/">
        <img
          src="/assets/logo-nlf-branca-w200.webp"
          alt=""
          class="w-full max-lg:max-w-[100px] lg:max-w-[150px] aspect-200/114 order-1"
        />
      </a>
    {/if} -->
    <MenuMobile class="sm:max-lg:order-3" />
    <Menu class="max-sm:w-full" />
    <div
      class="max-sm:hidden sm:flex sm:max-xl:flex-col justify-end items-end max-xl:gap-3 xl:gap-5"
    >
      <a
        href="/indique"
        class="max-xl:nlf-botao-compacto xl:nlf-botao nlf-botao--gold flex justify-center items-center text-preto gap-[10px]"
      >
      ...
      <a
        ...
        target="_blank"
        class="lg:items-center w-max lg:justify-center max-xl:nlf-botao-compacto xl:nlf-botao nlf-botao--azul flex gap-[10px]"
      >
        <svg width="21" height="21" viewBox="0 0 21 21">
          <path
            ...
            fill="white"
          />
        </svg><span class="text-branco w-max">Área do cliente</span></a
      >
    </div>
  </div>
  <Breadcrumbs classes="max-md:pl-5 md:nlf-padding md:pt-5 nlf-container" />
</header>
