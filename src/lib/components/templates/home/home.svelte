<script>
    ...
    import SecaoDepoimentos from "$lib/components/organisms/secao-depoimentos/secao-depoimentos.svelte";
...
<div class="flex flex-col items-center gap-[100px] w-full">
    <div class="flex flex-col items-center gap-[100px] padding w-full">
        <SecaoHero />
        <SecaoPlanos />
