<script>
  ...
  import SecaoEssencial from "$lib/components/organisms/secao-essencial/secao-essencial.svelte";
  import SecaoPromocional from "$lib/components/organisms/secao-promocional/secao-promocional.svelte";
